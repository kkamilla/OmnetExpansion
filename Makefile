...
clean:
	$(qecho) Cleaning...
	$(Q)-rm -rf $O
	$(Q)-rm -f packetgenerator packetgenerator.exe libpacketgenerator.so libpacketgenerator.a libpacketgenerator.dll libpacketgenerator.dylib
	$(Q)-rm -f ./*_m.cc ./*_m.h
